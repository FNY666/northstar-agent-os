...
| --- | --- | --- |
| [demo](demo/README.md) | product path (`bin/northstar agent`): one governed agent turn — Read + scripted model, session + checkpoint under workspace `.northstar/sessions` | `make demo` or `cd demo && sh run_offline.sh` |
