...
assert r['case_count']>=10 and r['all_cases_match']
assert sum(r['property_sweep']['counts'].values())==256
...
print('PASS: validator cases=%d sweep=256 mutually-exclusive=RECOVERED/UNKNOWN/REJECT'%r['case_count'])
